...
public sealed class RabbitMqWhatsAppOutboundPublisher : IWhatsAppOutboundPublisher
{
    private readonly IBus _publishEndpoint;

    public RabbitMqWhatsAppOutboundPublisher(IBus publishEndpoint)
    {
    ...
    public Task PublishAsync(SendWhatsAppMessageCommand command, CancellationToken cancellationToken)
    {
        return _publishEndpoint.Publish(command, context =>
        {
            ...
            context.Headers.Set("outbound-channel", "whatsapp");
